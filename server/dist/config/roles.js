        ...
        roleButtons: [
            {
                ...
                buttonDesc: "Вам необходимо записать пациентов из списка ожидания на приём к нужным им врачам. Ваша задача: для каждого пациента найти свободный слот в расписании его врача и занести туда данные.",
                buttonData: [
                    {
            ...
            },
            {
                ...
                buttonDesc: "Вам нужно корректно распределить результаты анализов по картам пациентов. Для этого перетащите каждый анализ в соответствующую папку.",
    ...
    },
    {
        ...
        roleButtons: [
            ...
            },
            {
                ...
                buttonTitle: "Посетить терапевта для получения направления к узкому специалисту",
                isActive: true,
            },
            {
                buttonEmit: "emit-message",
                buttonTitle: "Обратиться в регистратуру для записи к узкому специалисту",
                isActive: true,
            },
            {
                buttonEmit: "emit-message",
                buttonTitle: "Посетить узкого специалиста для подтверждения диагноза / необходимость льготного лекарства",
                isActive: true,
            },
            {
                buttonEmit: "emit-call",
                buttonTitle: "Обратиться в службу 666 чтобы выписали рецепт на льготное лекарство",
                isActive: true,
            },
            {
